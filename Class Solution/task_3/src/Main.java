...
public class Main {
    ...
    static String[] waiting_l = new String[3];

    static String waiting_name_f;
    static String waiting_name_l;
...
//                    if all the cabins are full puting the Customer in to the waiting list
                    System.out.println("\nCabins currently unavailable. would you like to add you to the waiting list(Y/N) ");
                    String option_2 = input.next();
                    if(option_2.toLowerCase().equals("y")){
                        Cabin.waitingList();
                    }else if(option_2.toLowerCase().equals("n"))
                        continue;
                    else
    ...
    static class Cabin{
                ...
                for(int j = 0; j < 3; j++){
                    ...
                    try {
                        ...
                        if (ship_cabins[i][j].f_name.equals(f_name) &&
                            ...
                            if (!(waiting_l[0]).equals(null));{
                                ship_cabins[i][j] = full_name;
                            }
        ...
        public static void total(){
            System.out.println("\nCost per passenger, or all passenger(O/A) ? ");
        ...
        public static void waitingList() {
            ...
            Scanner input = new Scanner(System.in);
            System.out.println("\nEnter your First name:");
            waiting_name_f = input.next();
            System.out.println("\nEnter your Last name:");
            waiting_name_l = input.next();

            full_name = waiting_name_f+ waiting_name_l;
            waiting_l[cnt] = String.valueOf(full_name);
            cnt++;
